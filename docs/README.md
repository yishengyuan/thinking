...
>
> 🛠️ 工具备查:[Teams 使用-群/频道/工作流与通知](Teams使用-群频道工作流与通知.md)。
...
| [k6压测实操](想法/k6压测实操.md) | k6 并发/负载测试:脚本结构、五种压测类型、VU vs 到达率模型、thresholds 判过没过、看 p95/p99、坑与跑法 |
| [Sentry排错数据流转](想法/Sentry排错数据流转.md) | 线上报错数据流:应用→SDK→Sentry(Issue/Seer)→MCP→Claude 对到代码定位修复→发版验证;含交互时序与注意 |
